...
function renderContent() {
  ...
  const renderCertItems = (list, items) => {
    (items || []).forEach(c => {
  ...
  renderCertItems(document.getElementById("certList"), DATA.certifications);
  renderCertItems(document.getElementById("formationList"), DATA.formations);
